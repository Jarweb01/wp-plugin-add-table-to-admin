<?php
/*
Plugin Name: Show table for requests
...
class TT_Example_List_Table extends WP_List_Table {
    ...
    function column_cb($item){
        return sprintf(
            '<input style="display:none;" type="checkbox" name="%1$s[]" value="%2$s" />',
    ...
    function get_columns(){
        $columns = array(
            'cb'        => '<input style="display:none;" type="checkbox" />', //Render a checkbox instead of text
            'title'     => 'Name',
            'email'    => 'Email',
            'animal'    => 'Animal',
            'shelter'  => 'Shelter',
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'animal'  => array('animal',false),
            'shelter'  => array('shelter',false),
    ...
    function prepare_items() {
        ...
        while ( $the_query->have_posts() ) : $the_query->the_post();
          ...
          array_push($postsData, array(
            'ID'        => $ID,
            'name'     => get_post_meta( $ID, 'name', 1 ),
            'email'     => get_post_meta( $ID, 'email', 1 ),
            'animal'    => get_post_meta( $ID, 'animal', 1 ),
            'shelter'  => get_post_meta( $ID, 'shelter', 1 ),
            'date'  => get_post_meta( $ID, 'date', 1 ),
        ));
...
function tt_add_menu_items(){
    add_menu_page('Pet adoption requests table', 'Pet adoption requests', 'activate_plugins', 'tt_list_test', 'tt_render_list_page');
...
function tt_render_list_page(){
    ...
    <div class="wrap">
        ...
        <h2>Table for pet adoption requests</h2>
